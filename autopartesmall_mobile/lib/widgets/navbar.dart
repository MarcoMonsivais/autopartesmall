...
import 'package:autopartes_mall/constants/cons.dart' as globals;
                              ...
                              GestureDetector(
                                onTap: (){
                                  Navigator.push(context, MaterialPageRoute(builder: (context) {
                                    return variousDetails(widget.searchController.text);
                                  }));
                                  print('2: ' + widget.searchController.text);
                                },
                                child: Icon(Icons.zoom_in, color: ArgonColors.muted)),
                          onTap: () {
                            print('1');
                            // print(widget.searchController.text);
  //                          textSearch = widget.searchController.text;
  //                          Navigator.pushNamed(context, '/pro');
                          }),
                    ),
                  SizedBox(
                          ...
                          child: Row(
                            children: [
                              Icon(Icons.filter_alt_rounded,
                                  color: ArgonColors.primary, size: 22.0),
                              SizedBox(width: 10),
